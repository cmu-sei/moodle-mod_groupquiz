...
window.addEventListener('load', function () {
    ...
    groupquiz.set('sesskey', window.rtqinitinfo.sesskey);
    groupquiz.set('siteroot', window.rtqinitinfo.siteroot);
    groupquiz.set('cmid', window.rtqinitinfo.cmid)
    ...
    var sorted = Sortable.create(questionList, {
        ...
        onSort: function (evt) {
            ...
            var params = {
                ...
                'cmid': groupquiz.get('cmid'),
                'questionorder': questionOrder,
                'action': 'dragdrop'
            };

            groupquiz.ajax.create_request('/mod/groupquiz/edit.php', params, function (status, response) {
