...
trait renderer_base {
    ...
    /** @var \mod_groupquiz\groupquiz $groupquiz */
    protected $groupquiz;
    ...
    public function base_header($tab = 'view')
    {
        ...
        echo groupquiz_view_tabs($this->groupquiz, $tab);
     ...
     */
    public function init($groupquiz, $pageurl, $pagevars = array())
    {
