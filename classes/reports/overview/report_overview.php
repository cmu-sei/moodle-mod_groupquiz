...
namespace mod_groupquiz\reports\overview;

use mod_groupquiz\reports\ireport;
use mod_groupquiz\tableviews\overallgradesview;

class report_overview extends \mod_groupquiz\reports\groupquiz_report_base implements ireport {
    ...
    /**
     * @var \mod_groupquiz\output\report_overview_renderer $renderer
     */
    protected $renderer;
    ...
    public function __construct(\mod_groupquiz\groupquiz $groupquiz) {
        ...
        $this->renderer = $PAGE->get_renderer('mod_groupquiz', 'report_overview');
