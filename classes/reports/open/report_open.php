...
namespace mod_groupquiz\reports\open;

use mod_groupquiz\reports\ireport;
use mod_groupquiz\tableviews\overallgradesview;

class report_open extends \mod_groupquiz\reports\groupquiz_report_base implements ireport {
    ...
    /**
     * @var \mod_groupquiz\output\report_open_renderer $renderer
     */
    protected $renderer;

    /**
     * report_open constructor.
     * @param \mod_groupquiz\groupquiz $groupquiz
     */
    public function __construct(\mod_groupquiz\groupquiz $groupquiz) {
        global $PAGE;

        $this->renderer = $PAGE->get_renderer('mod_groupquiz', 'report_open');
