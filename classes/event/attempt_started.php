...
/**
 * The mod_groupquiz started event.
 *
...
class attempt_started extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'groupquiz';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('eventattemptstarted', 'mod_groupquiz');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/groupquiz/view.php', array('id' => $this->contextinstanceid));
    }
